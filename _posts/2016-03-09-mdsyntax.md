...
---
## Markdown 语法说明 (简体中文版)
文章声明：本文转载自[hzmook的博客文档](http://hzmook.github.io/docs/mdsyntax.html)。  
...
行内式的图片语法看起来像是：
    ...
    ![Alt text](/path/to/img.jpg)<!--找不到图片时，将会显示Alt text文字，以代替图片显示。-->
...
![Markdown CheetSheet](/images/posts/mdcheatsheet.png)
